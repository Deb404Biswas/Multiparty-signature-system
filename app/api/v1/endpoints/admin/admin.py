...
try:
    ...
    logger.error(f"Error:{e}. Occurred while executing '/create-new-parties' endpoint")
    raise HTTPException(status_code=500,detail='Undocumeted error at server side.')
...
try:
    ...
    logger.error(f"Error:{e}. Occurred while executing '/lock-update' endpoint")
    raise HTTPException(status_code=500,detail='Undocumeted error at server side.')